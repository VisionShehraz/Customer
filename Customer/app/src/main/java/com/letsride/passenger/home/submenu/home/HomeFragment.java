package com.letsride.passenger.home.submenu.home;
...
import com.letsride.passenger.adapter.MainAdapterHome;
...
import com.letsride.passenger.home.submenu.TopUpActivity;
import com.letsride.passenger.mBox.BoxActivity;
import com.letsride.passenger.mFood.FoodActivity;
import com.letsride.passenger.mFood.FoodMenuActivity;
import com.letsride.passenger.mFood.FoodItemHome;
import com.letsride.passenger.mMart.MartActivity;
import com.letsride.passenger.mMassage.MassageActivity;
import com.letsride.passenger.mRideCar.RideCarActivity;
import com.letsride.passenger.mSend.SendActivity;
import com.letsride.passenger.mService.mServiceActivity;
import com.letsride.passenger.model.Banner;
...
import com.letsride.passenger.utils.ConnectivityUtils;
import com.letsride.passenger.utils.Log;
import com.letsride.passenger.utils.RecyclerTouchListener;
import com.letsride.passenger.utils.SnackbarController;
...
public class HomeFragment extends Fragment {
    ...
    private String[] name = {
            ...
            General.Name_Bakery,
            General.Name_Bulk_BigItem,
            General.Name_Catering,
            General.Name_Cluster,
            General.Name_Document_Courier,
            General.Name_Electric_Electronic, //
            General.Name_Flower,//
            General.Name_Food_Restaurant,
            General.Name_Furniture,
            General.Name_Grocery_Supermarket,
            General.Name_Hamper,
            General.Name_Healthcare,
            General.Name_Laundry,
            General.Name_MovingHouse_Office,
            General.Name_Online_Retail,
            General.Name_Parcel,
            General.Name_Vet,
            General.Name_Warehouse_Logistic,
            General.Name_Wine_Liquor,
            General.Name_Wedding_Service,
            General.Name_MovertoMalaysia,
            General.Name_TowTruck
    ...
    private Integer[] image = {
            ...
            R.drawable.cake,
            R.drawable.bulkbigitem,
            R.drawable.catering,
            R.drawable.cluster,
            R.drawable.documentcourier,
            R.drawable.electricstore,
            R.drawable.flower,

            R.drawable.foodrestaurant,
            R.drawable.furniture,
            R.drawable.groceries,
            R.drawable.hamper,
            R.drawable.healthcare,
            R.drawable.laundry,
            R.drawable.movinghouseoffice,
            ...
            R.drawable.wine,
            R.drawable.weddingservice,
            R.drawable.movertomalaysia,
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //layoutManager.getChildAt(0).setBackgroundColor(Color.parseColor("#808080"));
        //layoutManager.getChildAt(1).setBackgroundColor(Color.parseColor("#808080"));

        recyclerView_explore.setLayoutManager(layoutManager);
        recyclerView_explore.setNestedScrollingEnabled(true); //i change here
