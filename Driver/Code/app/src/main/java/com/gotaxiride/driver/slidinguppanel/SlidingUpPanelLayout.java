package com.gotaxiride.driver.slidinguppanel;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * Tinggi standar bayangan di atas panel yang mengintip
     */
    ...
    /**
     * Default disetel ke false karena begitulah yang tertulis
     */
    private static final boolean DEFAULT_OVERLAY_FLAG = false;
    /**
     * Default diatur ke true untuk panel klip karena alasan kinerja
     */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != MeasureSpec.EXACTLY && widthMode != MeasureSpec.AT_MOST) {
            ...
            throw new IllegalStateException("Tinggi harus memiliki nilai yang pasti atau MATCH_PARENT");
        }
        ...
        // Jika panel geser tidak terlihat, maka letakkan seluruh tampilan dalam keadaan tersembunyi
    ...
    public void setPanelState(PanelState state) {
        ...
        // Batalkan semua animasi yang sedang berjalan, untuk memungkinkan perubahan status
