...
public class BrowserActivity extends AppCompatActivity {
    ...
    private static final String URL_WEB = MyConfig.URL_SIGN_UP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg) {
                ...
                i.setType("*/*");
                BrowserActivity.this.startActivityForResult(Intent.createChooser(i, "Direktory File"), FCR);
            }
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                ...
                i.addCategory(Intent.CATEGORY_OPENABLE);
                i.setType("*/*");
                BrowserActivity.this.startActivityForResult(Intent.createChooser(i, "File Chooser"), BrowserActivity.FCR);
            }
